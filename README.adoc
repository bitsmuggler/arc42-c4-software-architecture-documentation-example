...
If you're looking for a step-by-step video on how to use this starter project, you can find it on youtube here: https://www.youtube.com/watch?v=TLcUISoEn2s[Software Architecture Documentation with arc42 and C4 Model - A Step-By-Step Walkthrough on Youtube]
